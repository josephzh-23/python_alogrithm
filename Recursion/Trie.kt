...
/*
1. Root always null in the trie
 */
...
object Trie {
    ...
    // A key would be the string example: string
    fun insert(key: String) {
        ...
        while (level < length) {
            ...
            // This would be like
            // t : 17   h: 7        based on alphabetical position as said
...
//        val keys = arrayOf("the", "a", "there", "answer", "any",
//                "by", "bye", "their")
