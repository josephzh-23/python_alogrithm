    ...
    def is_sub_island(self, x, y, grid1, grid2, visited):
        ...
        while pending_cells:
            ...
            for direction in self.directions:
                ...
                '''
                How to make sure the nextX is within the total rows? Well the way to do that is basically 
                
                using 0 <= nextX < totalRows and then 0 <= nextY < totalCols
                ...
                if (
                    0 <= next_x < total_rows
                    and 0 <= next_y < total_cols and not visited[next_x][next_y] and self.is_cell_land(next_x, next_y, grid2)
                ):
